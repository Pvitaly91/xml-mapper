...
@section('content')
    ...
    <section class="panel">
        ...
        <div class="detail-list">
            ...
            <div class="detail-row"><strong>Duration</strong><div>{{ $panel['performance']['latest']?->duration_ms ? number_format($panel['performance']['latest']->duration_ms).' ms' : 'n/a' }}</div></div>
