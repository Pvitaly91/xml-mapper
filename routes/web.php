...
Route::prefix('admin')->group(function (): void {
    ...
    Route::middleware(['auth', 'can:access-admin'])->name('admin.')->group(function (): void {
        ...
        Route::post('/feed-profiles/{feed_profile}/cutover', [FeedCutoverController::class, 'store'])->name('feed-profiles.cutover');
        ...
        Route::post('/feed-profiles/{feed_profile}/feedback/import', [FeedbackImportController::class, 'store'])->name('feed-profiles.feedback.store');
        ...
        Route::post('/feed-profiles/{feed_profile}/generations/{feed_generation}/first-pull-verify', [FeedFirstPullVerificationController::class, 'store'])->name('feed-profiles.generations.first-pull-verify');
