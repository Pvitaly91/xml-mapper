...
use App\Http\Controllers\Admin\FeedContentEnrichmentController;
...
use App\Http\Controllers\Admin\FeedGenerationArtifactController;
...
Route::prefix('admin')->group(function (): void {
    ...
    Route::middleware(['auth', 'admin.security', 'can:access-admin', 'admin.shop.context', 'admin.permission'])->name('admin.')->group(function (): void {
        ...
        Route::get('/feed-profiles/{feed_profile}/content-enrichment', [FeedContentEnrichmentController::class, 'index'])->name('feed-profiles.content-enrichment.index');
        Route::post('/feed-profiles/{feed_profile}/content-enrichment/apply', [FeedContentEnrichmentController::class, 'apply'])->name('feed-profiles.content-enrichment.apply');
        ...
        Route::get('/feed-profiles/{feed_profile}/generations/{feed_generation}/artifact/preview', [FeedGenerationArtifactController::class, 'preview'])->name('feed-profiles.generations.artifact.preview');
        Route::get('/feed-profiles/{feed_profile}/generations/{feed_generation}/artifact/download', [FeedGenerationArtifactController::class, 'download'])->name('feed-profiles.generations.artifact.download');
        ...
        Route::get('/feed-profiles/{feed_profile}/generations/{feed_generation}/reports/final-xml', [FeedReleaseReportController::class, 'finalXml'])->name('feed-profiles.generations.reports.final-xml');
        Route::get('/feed-profiles/{feed_profile}/generations/{feed_generation}/reports/final-xml/{type}', [FeedReleaseReportController::class, 'finalXmlDownload'])->name('feed-profiles.generations.reports.final-xml.download');
        ...
        Route::put('/feed-profiles/{feed_profile}/feed-items/{feed_item}/content-override', [FeedItemController::class, 'updateContentOverride'])->name('feed-profiles.feed-items.content-override');
